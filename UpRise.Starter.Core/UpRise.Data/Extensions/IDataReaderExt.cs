...
namespace UpRise.Extensions
{
    public static class IDataReaderExt
    {
        ...
        */
        ...
        public static byte GetSafeByte(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
        ...
        public static byte? GetSafeByteNullable(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                return reader.GetByte(ordinal);
        ...
        public static short GetSafeInt16(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
        ...
        public static short? GetSafeInt16Nullable(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                return reader.GetInt16(ordinal);
        ...
        public static TimeSpan GetSafeTimeSpan(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)

            {
                SqlDataReader sqlData = reader as SqlDataReader;
                return sqlData.GetTimeSpan(ordinal);
            }
            else
            {
                return default;
        ...
        public static TimeSpan? GetSafeTimeSpanNullable(this IDataReader reader, int ordinal)
        {
            if (reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                SqlDataReader sqlData = reader as SqlDataReader;
